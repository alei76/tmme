...
import org.tmme.ci.common.utils.JsonSerializer;
...
public class SearchServiceImpl implements SearchService {
	...
	private final RestTemplate solrRestTemplate;

	private final Set<String> ignorableFields;
	private final String solrUpdateUrl;

	public SearchServiceImpl(final SolrServer solrServer,
			final RestTemplate solrRestTemplate, final String solrUpdateUrl,
			final Set<String> ignorableFields) {
		Validate.notNull(solrServer);
		Validate.notNull(solrRestTemplate);
